...
export function countLines(input, maxCols) {
  return offsetToColRow(input, input.replace(ansiRegex(), "").length, maxCols).row + 1;  // FIXED: Make sure cursor behaves well with a color prompt. Source: <https://github.com/wavesoft/local-echo/issues/24>
}
