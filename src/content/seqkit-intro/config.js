...
export const config = {
	...
	steps: [
		...
		{ name: "Getting Started", component: Step1, subtitle: "Summarize a file", header: true },
		{ name: "Getting Started", component: Step2, subtitle: "Downsample a file" },
		{ name: "Getting Started", component: Step3, subtitle: "Output sequence IDs" },
