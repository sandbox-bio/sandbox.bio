...
{:else if prereqStatus === PREREQ_STATUS_DONE}
	<p>
		You already completed the prerequisite <strong><a target="_blank" href="/tutorials?id={PREREQ_ID}">Terminal Basics</a></strong> tutorial, so you're
		ready to get started with this course!
	</p>
{:else}
	<p>
		Before we get started, it's encouraged (but not required) to finish the <strong>Terminal Basics</strong> tutorial before you proceed with this course.
		That tutorial will introduce you to important concepts to help you get up to speed.
	</p>
